...
import com.sj.app.common.BaseErrorCode;
...
public class GlobalExceptionHandler {
                ...
                if (e instanceof HttpRequestMethodNotSupportedException) {
                    ...
                    if (e instanceof HttpMediaTypeNotSupportedException) {
                        ...
                        if (e instanceof MethodArgumentNotValidException) {
                            return ResponseVO.errorResponse(416, Objects.requireNonNull(
                                                                                ((MethodArgumentNotValidException) e).getBindingResult().getFieldError())
                                                                        .getDefaultMessage(), request.getServletPath());
                        }
                    }
                }
            }
    ...
    public ResponseVO<Object> bindExceptionHandler(BindException e) {
        ...
        return ResponseVO.errorResponse(BaseErrorCode.PARAMETER_ERROR.getCode(), BaseErrorCode.PARAMETER_ERROR.getMsg(),
                                        collect);
    }
